...
public class H4_1_Tests {
    ...
    @Test
    public void testParseInitialState() throws IOException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, KissParserException {
        var scanner = new H4_TokenScanner(".r", "START");
        var builder = mock(FsmBuilder.class);
        var parser = new FsmParser(scanner, builder);
        var method = Util.getPrivateParserMethod("parseInitialState");

        method.invoke(parser);
        verify(builder).setInitialState("START");
        verifyNoMoreInteractions(builder);
    }

    @Test
    public void testParseOutputWidthException() throws IOException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, KissParserException {
        var scanner = new H4_TokenScanner(".o", "foo");
        var builder = mock(FsmBuilder.class);
        var parser = new FsmParser(scanner, builder);
        var method = Util.getPrivateParserMethod("parseOutputWidth");
        ...
        var context = contextBuilder()
            .add("input", ".o foo")
            .subject("FsmParser#parseOutputWidth")
            .build();

        assertThrows(BadNumberException.class, () -> Util.callAndUnpackException(method, parser), context,
            TR -> "Parser did not throw the expected exception");
    }

    @Test
    public void testParseNumberOfTermsException() throws IOException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, KissParserException {
        var scanner = new H4_TokenScanner(".p", ".i");
        var builder = mock(FsmBuilder.class);
        var parser = new FsmParser(scanner, builder);
        var method = Util.getPrivateParserMethod("parseNumberOfTerms");
        ...
        var context = contextBuilder()
            .add("input", ".p .i")
            .subject("FsmParser#parseNumberOfTerms")
            .build();
    ...
    @Test
    public void testParseNumberOfStatesException() throws IOException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, KissParserException {
        var scanner = new H4_TokenScanner(".s", "?");
        var builder = mock(FsmBuilder.class);
        var parser = new FsmParser(scanner, builder);
        var method = Util.getPrivateParserMethod("parseNumberOfStates");
        ...
        var context = contextBuilder()
            .add("input", ".s ?")
            .subject("FsmParser#parseNumberOfStates")
            .build();
    ...
    @Test
    public void testParseInitialStateException() throws IOException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, KissParserException {
        var scanner = new H4_TokenScanner(".r", "-");
        var builder = mock(FsmBuilder.class);
        var parser = new FsmParser(scanner, builder);
        var method = Util.getPrivateParserMethod("parseInitialState");
        ...
        var context = contextBuilder()
            .add("input", ".r -")
            .subject("FsmParser#parseInitialState")
            .build();

        assertThrows(BadIdentifierException.class, () -> Util.callAndUnpackException(method, parser), context,
            TR -> "Parser did not throw the expected exception");
    }
